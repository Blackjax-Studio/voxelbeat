...
export default function AlertModal({
  ...
  return (
    <div
      className="fixed inset-0 z-[140] flex items-center justify-center p-4 sm:p-6 md:p-8"
      onClick={onClose}
    >
      {/* Backdrop */}
      ...
      {/* Modal */}
      <div
        className="relative w-full max-w-sm rounded-3xl animate-slideUp flex flex-col bg-zinc-900 isolation-auto"
