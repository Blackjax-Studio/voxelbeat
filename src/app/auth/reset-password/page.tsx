...
// This is a client component, but we can't export metadata from client components.
// We need to move it to a layout or wrap it.
// However, since it's already "use client", we can just add a head tag inside the component.
...
export default function ResetPasswordPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 bg-black">
      <head>
        <title>Reset Password | VoxelBeat</title>
